...
### 2. java8 也具备了像方法中传入代码块的能力
在java8以前，函数式不能作为参数传入方法的的，java8后提供了@Functional的功能，使java有了与ruby相似的能力。
...
#### 2.重构
下面我们在CacheHelper中写一个新方法,他传入一个函数(Supplier) 用于在缓存没有命中的时候获取数据库的内容，一个Type表示数据的类型
```
//CacheHelper.java
